...
<!---The chunk allows errors when knitting--->
...
```
* Seems like the month column contains Chinese characters...I tried to remove them and didn't succeed. I guess it depends on one's computer settings.
...
ggplot(gapminder) +
  ...
  scale_x_log10("GDP per capita", labels = scales::dollar_format()) +  # The dollar format is very useful
  labs(y = "Life expectancy") # Labs can be added separately or together
```
